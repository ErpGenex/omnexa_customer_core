...
from omnexa_customer_core.cc_gap_register import get_gap_status
from omnexa_customer_core.cc_global_benchmark import get_global_cc_score

@frappe.whitelist()
def export_cc_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_CUSTOMER_CORE_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_cc_score(), get_gap_status()
