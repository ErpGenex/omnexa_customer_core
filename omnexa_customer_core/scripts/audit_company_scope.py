#!/usr/bin/env python3
"""Audit company/branch scoping — omnexa_customer_core."""
...
def run():
	...
	return {"ok": True, "app": "omnexa_customer_core", "company": company, "branch": branch, "uses_session_context": bool(company)}
