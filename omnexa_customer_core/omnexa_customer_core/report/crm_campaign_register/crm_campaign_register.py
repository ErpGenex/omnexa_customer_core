...
def execute(filters=None):
	data = frappe.db.sql(
		"""
		SELECT `name`, `campaign_name`, `company`, `branch`, `campaign_type`, `status`
	...
	columns = [
		...
		{"label": _("Campaign Name"), "fieldname": "campaign_name", "fieldtype": "Data", "width": 120},
		{"label": _("Company"), "fieldname": "company", "fieldtype": "Link", "width": 120},
		{"label": _("Branch"), "fieldname": "branch", "fieldtype": "Link", "width": 120},
		{"label": _("Campaign Type"), "fieldname": "campaign_type", "fieldtype": "Select", "width": 120},
